...
// Flags
#define P_FLAG_SUMMARY_SCREEN_IV_EV_INFO 0 //FLAG_SUMMARY_SCREEN_IV_EV_INFO // If this flag is set, will allow player to cycle through the Stats, IVs, and EVs in the summary screen skills page. Note: if P_SUMMARY_SCREEN_IV_EV_INFO is TRUE, this flag does nothing.
